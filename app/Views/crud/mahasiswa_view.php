<div class="container-fluid">
    ...
    <div class="card mb-3">
        <div class="card-header">
            <a href="<?php echo site_url('dashd/form_mhs') ?>"><i class="fas fa-plus"></i> Tambah</a>
        </div>
        <div class="card-body">
                ...
                <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        foreach ($tbl_mahasiswa as $key) { ?>
                            <tr>
                                <td><?php echo $no++; ?></td>
                                <td><img style="width:40px; height:40px; border-radius: 100%;" src="<?php echo base_url($key->foto); ?>" ></td>
