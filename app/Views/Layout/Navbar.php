...
<!-- Topbar Search -->
<form
class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 mymd-0 mw-100 navbar-search">
...
<a class="dropdown-item" href="#" data-toggle="modal" datatarget="#logoutModal">
